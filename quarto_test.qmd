...
Ved hjælp af prædiktionsmodeller inden for machine learning og en analyse af interne og eksterne faktorer, gives en række løsningsforslag til virksomheden. Analyserne har dannet grundlag for følgende anbefalinger:
- Fortsætte med at uddanne personalet inden for håndtering og anvendelse af data, så det bliver en fast del af arbejdsgangen
- Indsamling af data om VIP-gæsternes afhentningstidspunkter kan potentielt være med til at identificere mønstre i deres adfærd
